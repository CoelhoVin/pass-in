...
public class EventController {
    ...
    public ResponseEntity<AttendeeListResponseDTO> getEvenAttendees(@PathVariable String id){
        AttendeeListResponseDTO attendeeListResponseDTO = this.attendeeService.getEventAttendee(id);
